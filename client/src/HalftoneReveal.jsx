...
void main() {
  ...
  vec3 originalSharp = gradeRGB(vec3(
  ...
  // --- NEW MAGIC: Force the revealed image into the custom palette ---
  float sharpLum = dot(originalSharp, vec3(0.299, 0.587, 0.114));
  vec3 tintedSharp = mix(uInk, uPaper, sharpLum);
  // -------------------------------------------------------------------

  vec3 col = mix(print, tintedSharp, focus);
